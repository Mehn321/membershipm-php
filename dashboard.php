...
$fetchLogoQuery = "SELECT logo FROM settings WHERE settingsID = 1";
    ...
    <div class="card-body p-0">
        <ul class="products-list product-list-in-card pl-2 pr-2">
            ...
            while ($row = $recentMembersResult->fetch_assoc()) {
                ...
                echo '<span class="badge badge-dark float-right">' . getMembershipTypeName($row['membership_typeID']) . '</span>';
...
function getMembershipTypeName($membership_typeID)
{
    global $conn;
