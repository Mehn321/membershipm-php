...
$fetchCurrencyQuery = "SELECT currency FROM settings WHERE settingsID = 1";
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='edit_type.php?id={$row['membership_typeID']}' class='btn btn-primary'><i class='fas fa-edit'></i> Edit</a>
                            <button class='btn btn-danger' onclick='deleteMembership({$row['membership_typeID']})'><i class='fas fa-trash'></i> Delete</button>
                          </td>";
                    echo "</tr>";
                    $counter++;
