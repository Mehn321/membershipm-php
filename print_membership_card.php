...
$selectQuery = "SELECT members.*, membership_types.type AS membership_type_name
                FROM members
                JOIN membership_types ON members.membership_typeID = membership_types.membership_typeID
                WHERE members.members_id = $memberId";
...
$fetchSettingsQuery = "SELECT system_name FROM settings WHERE settingsID = 1";
